...
$(".add-row").click(function () {
  $("#editableTable").find("tbody tr:first").before("<tr><td data-field='char'></td><td data-field='name'></td><td data-field='type'></td><td data-field='optional'></td><td data-field='necessary'></td><td data-field='order'></td><td><a class='button button-small edit' title='Edit'><i class='zmdi zmdi-edit'></i></a> <a class='button button-small' title='Delete'><i class='zmdi zmdi-delete'></i></a></td></tr>");
  editTable();
  setTimeout(function () {
